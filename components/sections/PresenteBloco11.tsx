    ...
    <Section>
      <Container className="text-center space-y-6">
        ...
        <Body className="text-white/80 max-w-2xl mx-auto">
          Um guia direto e prático com tudo o que você precisa para começar a ajustar sua rotina, melhorar o sono, reduzir a ansiedade, desinchar e preparar seu corpo para reagir de verdade.
        </Body>
        <a
