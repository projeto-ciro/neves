  ...
  return (
    <Section id="sobre" className="scroll-mt-28">
      <Container className="text-center space-y-6">
        <Title className="text-gray-900">Quem é seu mentor: Ciro Neves</Title>
        <Body className="text-gray-700 max-w-3xl mx-auto">
          Sou Ciro Neves, personal trainer com mais de 20 anos de experiência e especialista
          em emagrecimento para mulheres acima dos 40 anos...
        </Body>
